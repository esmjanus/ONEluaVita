...
while not mode do
	...
	screen.print(480, 10, "Adhoc Sample", 1, color.white, color.green, __ACENTER)
...
while true do
	...
	local msg, len = adhoc.recv()
	if len > 0 then buff = buff .. msg end

	if back then back:blit(0,0) end
	screen.print(480, 10, "Adhoc Chat Room", 1, color.white, color.green, __ACENTER)
	screen.print(10, 30, buff)
	screen.flip()
